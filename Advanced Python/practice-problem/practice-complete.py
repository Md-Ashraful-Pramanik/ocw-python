...
class UserController:
    def __init__(self):
        ...
        if os.path.exists(USERS_FILE_NAME):
            with open(
                ...
                for user_json in f.readlines():
                    self.users.append(User.model_validate_json(user_json))
    ...
    def sign_up_user(self):
        ...
        with open(USERS_FILE_NAME, mode='a', encoding='utf-8') as f:
